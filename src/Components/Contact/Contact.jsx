    ...
    <div id='contact-div'>
        ...
        <h5 className="card-header  black-text text-center py-4">
            ...
            <div className="md-form mt-3">
                ...
                <label for="materialContactFormName" placeholder='Your Name'></label>
            </div>
            <div className="md-form">
                <input type="email" id="materialContactFormEmail" class="form-control"/>
                <label for="materialContactFormEmail" placeholder='Your Email'></label>
            </div>
            <div className="md-form">
                <textarea id="materialContactFormMessage" class="form-control md-textarea" rows="3"></textarea>
                <label for="materialContactFormMessage" placeholder='Leave a message....'></label>
            </div>            
